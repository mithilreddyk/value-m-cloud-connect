          ...
          {isAuthenticated ? (
            <div className="flex items-center gap-4">
              ...
              <Button 
                ...
                size="sm" 
                onClick={logout} 
                className="flex items-center gap-1 bg-white/20 hover:bg-white/30 text-black font-medium"
              >
            ...
            <div className="flex items-center gap-4">
              <Link to="/login">
                <Button variant="secondary" size="sm" className="bg-white/20 hover:bg-white/30 text-black font-medium">
                  Log in
                </Button>
              </Link>
              <Link to="/signup">
